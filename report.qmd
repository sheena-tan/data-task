...
Out of all participants who consented to participate (*N* = 61), responses that were incomplete or did not pass the attention check were removed, resulting in *N* = 46 total participants. We define “whether people care” about getting a return apology as a significant difference in emotional response within participants between the two apology scenarios – not getting (“you alone apologize”) and getting (“both apologize, you apologize first”) a return apology. A paired samples t-test was conducted to compare the two scenarios. Participants responded *significantly more negatively* when not receiving a return apology (*M* = -18.3, *SD* = 11.9) than when they did receive one (*M* = 7.54, *SD* = 14.4), *t*(45) = -12.58, *p* < .001, 95% CI [-30.01, -21.73], suggesting that people do not like when they do not receive a return apology. This pattern holds for each initiator type. The same paired samples t-test was conducted, grouping by initiator type. See *Table 1* for detailed results. Participants of each initiator type still respond *significantly more negatively* when not receiving a return apology than when they did receive one.

The extent of these differences vary, but the variation is not significantly different between the three initiator types. A one-way ANOVA was conducted with the null hypothesis that the true difference between emotional reactions when receiving and not receiving a return apology for each initiator type are equal, but there was *no statistically significant difference* in residuals between at least two initiator groups (*F*(2, 43) = 0.457, *p* = 0.636). Tukey’s HSD Test for multiple comparisons confirmed that there was no statistically significant difference between conditional initiators and always initiators (*p* = 0.947), never initiators and always initiators (*p = 0.749), or never initiators and conditional initiators (*p* = 0.617). The results suggest that differences between emotion reaction ratings when receiving and not receiving a return apology do not vary as a function of initiator type. However, patterns of interest specific to initiator types do exist. For example, conditional types seem to experience the strongest negative reactions to no return apology (*Figure 1*), which may be either a result of or a behavioral explanation for why this type avoids apologizing first without one.

Notably, a return apology is not merely a form of forgiveness. A paired-sample t-test was conducted to compare the emotion reaction ratings between receiving a return apology and receiving no return apology but being forgiven. Even when being forgiven, participants still responded significantly more negatively when not receiving a return apology (M = -13.4, SD = 15.9) than when they did receive one (M = 7.54, SD = 14.4), t(45) = -7.838, p < .001, 95% CI [-26.29, -15.54], suggesting that a return apology means more than mere forgiveness. If forgiveness was an equal substitute for a return apology, being forgiven without a return apology should result in the same emotional response as receiving one. Extensive literature on conciliation suggests that verbal apologies function as a strategy for humans to seek forgiveness when they have harmed others (Fehr et. al, 2010; McCullough, 2008). As such, receiving a return apology signals that the other party is likewise seeking your forgiveness, not only making an act of forgiving you. Social and cultural factors like a difference in power between parties  could influence the extent of these feelings, but overall, being the only one to apologize will not feel good, and both parties apologizing to each other will.
